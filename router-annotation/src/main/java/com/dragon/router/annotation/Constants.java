package com.dragon.router.annotation;
...
public class Constants {
    ...
    // custom interface
    private static final String FACADE_PACKAGE = "com.dragon.router.core";
    ...
    // Annotation type
    public static final String ANNOTATION_TYPE_ROUTE = "com.dragon.router.annotation.Route";
    public static final String ANNOTATION_TYPE_INTERCEPTOR = "com.dragon.router.annotation.Interceptor";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.dragon.router.routes";
